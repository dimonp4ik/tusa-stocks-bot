...
def get_daily_digest() -> dict:
    ...
    prompt = f"""Ты — аналитик рынка акций США. Вот заголовки новостей за последние 18 часов.

{headlines_text}

Выбери до 5 РАЗНЫХ самых важных для рынка акций США (S&P500/Nasdaq). КАЖДАЯ новость уникальна — НЕ повторяй одну и ту же. Если важных меньше 5 — выведи меньше строк. Для каждой — одна строка:
