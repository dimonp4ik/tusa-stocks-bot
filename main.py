...
def webhook():
    ...
    # ❓ Помощь
        ...
        _reply(chat_id,
               ...
               "  🎯 *TP2* — вторая цель. Потолок для остатка\n"
               "  🛑 *SL* — стоп-лосс. Выход если цена пошла против\n\n"
               "*Как работает сделка:*\n"
               "  1. Сигнал открыт — бот ждёт TP1 или SL\n"
               "  2. TP1 взят — 50% позиции закрыто в прибыли\n"
               "  3. Остаток ведётся *трейлинг-стопом*: стоп ползёт\n"
               "     за ценой и никогда не опускается ниже входа\n"
